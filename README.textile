...
After running this live on your site, you will see some new data in Event Tracking section of Google Analytics.
...
* Allow forcing of cohort selection, useful for tests.
