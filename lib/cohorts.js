Cohorts = (function () {
    ...
    var Test = (function () {
        ...
        var constructor = function (options) {
            ...
            if (!this.options.storageAdapter) throw ('You must specify a storage adapter for a test');
        ...
        constructor.prototype = {
            run: function () {
                ...
                if (in_test) {
                    ...
                    this.options.storageAdapter.onInitialize(in_test, this.options.name, chosen_cohort, this.options.storageAdapter.cv_slot, this.options.scope);
